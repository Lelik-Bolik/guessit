...
const Color _kThumbColor = Colors.white;
...
class GuessItSlidingSegmentedControl<T> extends StatefulWidget {
...
class _SegmentedControlState<T> extends State<GuessItSlidingSegmentedControl<T>>
    with TickerProviderStateMixin<GuessItSlidingSegmentedControl<T>> {
  ...
  @override
  void didUpdateWidget(GuessItSlidingSegmentedControl<T> oldWidget) {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget child) {
        ...
        final Widget box = _SegmentedControlRenderWidget<T>(
          thumbRadius: Radius.circular(widget.cornerRadius),
          children: children,
...
class _RenderSegmentedControl<T> extends RenderBox
  ...
  void _paintThumb(PaintingContext context, Offset offset, Rect thumbRect) {
    ...
    final RRect thumbRRect = RRect.fromRectAndRadius(thumbRect.shift(offset), thumbRadius);
